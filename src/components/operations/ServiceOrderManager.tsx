  ...
  const filtered = useMemo(() => {
    return orders.filter(o => {
      ...
      if (search) {
        ...
        const matches = [o.os_number, o.product, o.responsible_name, o.defect]
    ...
    <div className="space-y-4">
      ...
      <div className="hidden md:block">
        <Table>
          ...
          <TableBody>
            {filtered.length === 0 ? (
              <TableRow><TableCell colSpan={7} className="text-center text-muted-foreground">Nenhuma OS encontrada</TableCell></TableRow>
            ) : filtered.map(o => (
